...
class Service(models.Model):
    vendor = models.ForeignKey(Vendor, on_delete=models.CASCADE, related_name='videographer')
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='videographer')
    ...
    thumbnail = models.ImageField(upload_to='service/videographer/thumbnail', null=True)
    ...
    def __str__(self):
        return f'{(self.category).capitalize()} Videographer'
...
class Lead(models.Model):
    ...
    vendor = models.ForeignKey(Vendor, on_delete=models.CASCADE, related_name='videographer_leads')
...
class CallbackRequest(models.Model):
    vendor = models.ForeignKey(Vendor, on_delete=models.CASCADE, related_name='videographer_callback_request')
...
class Gallery(models.Model):
    ...
    vendor = models.ForeignKey(Vendor, on_delete=models.CASCADE, related_name='videographer_gallery')
    image = models.ImageField(upload_to='service/videographer/gallery', null=True)
...
class Review(models.Model):
    vendor = models.ForeignKey(Vendor, on_delete=models.CASCADE, related_name='videographer_reviews')
    service = models.ForeignKey(Service, on_delete=models.CASCADE, related_name='reviews')
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='videographer_reviews')
...
class ReportService(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='videographer_reports')
    uid = models.CharField(max_length=10, default="", editable=False)
    reason = models.CharField(max_length=150)
    description = models.TextField()
    screenshot = models.ImageField(upload_to='reports/videographer/screenshot', null=True)
    created_at = models.DateTimeField(auto_now_add=True) 
    updated_at = models.DateTimeField(auto_now=True) 
...
class ReportReview(models.Model): 
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='videographer_review_report')
    uid = models.CharField(max_length=10, default="", editable=False)
    reason = models.CharField(max_length=150)
    created_at = models.DateTimeField(auto_now_add=True) 
    updated_at = models.DateTimeField(auto_now=True) 
...
class Like(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='videographer_likes')
    service = models.ForeignKey(Service, on_delete=models.CASCADE, related_name='likes')
    vendor = models.ForeignKey(Vendor, on_delete=models.CASCADE, related_name='videographer_likes')
    created_at = models.DateTimeField(auto_now_add=True) 
...
class Save(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='videographer_saves')
    service = models.ForeignKey(Service, on_delete=models.CASCADE, related_name='saves')
    vendor = models.ForeignKey(Vendor, on_delete=models.CASCADE, related_name='videographer_saves')
    created_at = models.DateTimeField(auto_now_add=True) 
